...
const navLinks = [
  ...
  { label: 'Payments', path: '/tenant/payments', icon: BadgeDollarSign },
  { label: 'Bills', path: '/tenant/bills', icon: FileText },
];
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-white/10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-xs text-[#CBD5E1]">Tenant Panel</span>
            </div>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <header className="flex items-center justify-between bg-white border-b border-[#E2E8F0] px-4 py-0 h-16 shrink-0">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="hidden sm:flex items-center gap-2">
              ...
              <Badge label="Tenant" variant="info" />
            </div>
            <button
