...
import { createWaterBill } from "../../api/billApi";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        previousReading: companyDetails.waterPreviousReading || 0,
        currentReading: parseFloat(currentReading),
        dueDate: new Date(dueDate).toISOString(),
      };
      await createWaterBill(payload);
      setToast({ message: 'Water Utility Created Successfully', type: 'success' });
      // Reset form
      setTenantId('');
      setCompanyDetails(null);
      setCurrentReading('');
      ...
      setError(err.response?.data?.message || 'Failed to create water bill');
      setToast({ message: err.response?.data?.message || 'Failed to create water bill', type: 'error' });
    } finally {
    ...
    <div className="p-4 sm:p-6 max-w-screen-xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-[#1E293B]">Create Water Bill</h1>
        </div>
        <p className="text-sm text-[#64748B]">
          Generate a new water utility bill by looking up a tenant and entering current meter reading.
        </p>
      </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-[#1E293B]">{companyDetails.waterPreviousReading ?? 0} units</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-red-600">{formatCurrency(companyDetails.waterOutstanding)}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="number"
                    step="0.01"
                    min={companyDetails.waterPreviousReading || 0}
                    required
                  ...
                  <p className="text-xs text-[#64748B] mt-1">
                    Previous: {companyDetails.waterPreviousReading ?? 0} units
                    {currentReading && parseFloat(currentReading) >= (companyDetails.waterPreviousReading || 0) && (
                      <span className="text-emerald-600 ml-2">
                        Units used: {parseFloat(currentReading) - (companyDetails.waterPreviousReading || 0)}
                      </span>
                    )}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-[#E2E8F0] p-5">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-[#64748B]">Submit to generate the water bill. The system calculates units consumed automatically.</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-[#E2E8F0] p-5">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-[#1E293B]">{companyDetails.waterPreviousReading ?? 0} units</span>
                </div>
                {currentReading && (
                  <>
                    <div className="flex justify-between text-sm">
                    ...
                    <div className="flex justify-between text-sm border-t border-[#E2E8F0] pt-2">
                      ...
                      <span className="font-semibold text-[#002365]">
                        {parseFloat(currentReading) - (companyDetails.waterPreviousReading || 0)} units
                      </span>
                    </div>
                  </>
                )}
