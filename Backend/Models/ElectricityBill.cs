// Id — int
// ElectricityUtilityId — int (FK) → ElectricityUtility.Id
...
namespace Backend.Models
{
    public class ElectricityBill
    {
        ...
        public int ElectricityUtilityId { get; set; } // FK to ElectricityUtility
        public int TenantId { get; set; } // FK to Tenant

        public ElectricityUtility ElectricityUtility { get; set; } = null!;// Navigation property
